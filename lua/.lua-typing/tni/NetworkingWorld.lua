...
local NetworkingWorld = {}

function NetworkingWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function NetworkingWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function NetworkingWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function NetworkingWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function NetworkingWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function NetworkingWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function NetworkingWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
function NetworkingWorld.try_release_program(prog_scene) end

---@param candid string
function NetworkingWorld.add_autocomplete_candidate(candid) end

---@param candid string
function NetworkingWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function NetworkingWorld.get_loc_index(loc) end

---@param sfp string
function NetworkingWorld.add_location(sfp) end

---@param peer_id integer
---@return MultiplayerMouse
function NetworkingWorld.add_player(peer_id) end

function NetworkingWorld.try_resume_daycycle() end

function NetworkingWorld.master_timeout() end

function NetworkingWorld.second_elapsed() end

function NetworkingWorld.artifact_timeout() end

---@param peer_id integer
function NetworkingWorld.remove_player(peer_id) end

---@return Object
function NetworkingWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function NetworkingWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function NetworkingWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function NetworkingWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function NetworkingWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function NetworkingWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function NetworkingWorld.sync_pmsg_delta(s_pmsg) end

function NetworkingWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function NetworkingWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function NetworkingWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function NetworkingWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function NetworkingWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function NetworkingWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function NetworkingWorld.remove_player_hosting(fqdn) end

---@param fqdn Object
---@param netaddr Object
function NetworkingWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function NetworkingWorld.update_server_timescale(timescale_arg) end
...
function NetworkingWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function NetworkingWorld.acquire_all_tech() end

function NetworkingWorld.enable_all_listings() end

function NetworkingWorld.enable_all_tech_and_listings() end
