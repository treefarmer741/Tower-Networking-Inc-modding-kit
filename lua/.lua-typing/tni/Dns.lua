...
function Dns.create_debugger_ctx(debugger_lgctl, traffic_type, request_data) end
...
---@return TraversalContext
function Dns.access_node_from_debugger(stdout, debugger, node_addr, allow_user_nodes) end
