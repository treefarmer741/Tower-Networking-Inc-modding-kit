...
---@class EndlessBetaWorld : GameWorld
...
function EndlessBetaWorld.add_location(sfp, suppress_notification) end
...
function EndlessBetaWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function EndlessBetaWorld.get_device_replacement_rate(_device) end
