...
---@class _2026BetaWorld : GameWorld
...
function _2026BetaWorld.add_location(sfp, suppress_notification) end
...
function _2026BetaWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function _2026BetaWorld.get_device_replacement_rate(_device) end
