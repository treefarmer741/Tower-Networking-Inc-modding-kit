...
---@class A13RipSetupWorld : GameWorld
...
local A13RipSetupWorld = {}

function A13RipSetupWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function A13RipSetupWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function A13RipSetupWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function A13RipSetupWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function A13RipSetupWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function A13RipSetupWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function A13RipSetupWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function A13RipSetupWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function A13RipSetupWorld.add_autocomplete_candidate(candid) end

---@param candid string
function A13RipSetupWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function A13RipSetupWorld.get_loc_index(loc) end

---@param sfp string
---@param suppress_notification boolean?  # Default = false
function A13RipSetupWorld.add_location(sfp, suppress_notification) end

---@param peer_id integer
---@return MultiplayerMouse
function A13RipSetupWorld.add_player(peer_id) end

function A13RipSetupWorld.try_resume_daycycle() end

function A13RipSetupWorld.master_timeout() end

function A13RipSetupWorld.second_elapsed() end

function A13RipSetupWorld.artifact_timeout() end

---@param peer_id integer
function A13RipSetupWorld.remove_player(peer_id) end

---@return Object
function A13RipSetupWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function A13RipSetupWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function A13RipSetupWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function A13RipSetupWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function A13RipSetupWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function A13RipSetupWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function A13RipSetupWorld.sync_pmsg_delta(s_pmsg) end

function A13RipSetupWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function A13RipSetupWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function A13RipSetupWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function A13RipSetupWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function A13RipSetupWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function A13RipSetupWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function A13RipSetupWorld.remove_player_hosting(fqdn) end

---@param traffic_class string
---@param hex_rgb string
function A13RipSetupWorld.set_tap_traffic_color(traffic_class, hex_rgb) end

---@param fqdn Object
---@param netaddr Object
function A13RipSetupWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function A13RipSetupWorld.update_server_timescale(timescale_arg) end
...
function A13RipSetupWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function A13RipSetupWorld.acquire_all_tech() end

function A13RipSetupWorld.enable_all_listings() end

function A13RipSetupWorld.enable_all_tech_and_listings() end

---@param _device DeviceUnit
---@return number
function A13RipSetupWorld.get_device_replacement_rate(_device) end
