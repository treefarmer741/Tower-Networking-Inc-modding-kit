...
---@class ModdedDeviceUnit : DeviceUnit
---@field ModdedDeviceUnitScene string # Constant value: <PackedScene>
---@field DESCRIPTION_SUFFIX string # Constant value: 
~ Provided by {mod_name} ({mod_id})
---@field mod_id string
---@field mod Mod
---@field device_data_id string
---@field device_data_index integer
---@field device_data table<any,any>
---@field device_scene PackedScene
...
local ModdedDeviceUnit = {}

---@param device_scene PackedScene
---@return DeviceListing
function ModdedDeviceUnit.create_test_listing(device_scene) end

function ModdedDeviceUnit.apply_autoconfig() end

---@param new_pos Vector2
function ModdedDeviceUnit.reposition(new_pos) end

---@param new_pos Vector2
function ModdedDeviceUnit.elevator_move(new_pos) end

---@return number
function ModdedDeviceUnit.get_device_bounding_height() end

---@return Vector2
function ModdedDeviceUnit.get_global_y_range() end

---@return Vector2
function ModdedDeviceUnit.get_local_y_range() end

---@return Object
function ModdedDeviceUnit.debug_monitor_callback() end

---@return Object
function ModdedDeviceUnit.debug_mux_setup() end

---@return Object
function ModdedDeviceUnit.update_in_trolley_state() end

---@param new_picker Object
---@return boolean
function ModdedDeviceUnit.pickup(new_picker) end

---@param impulse Object?  # Default = (0.0, 0.0)
---@return boolean
function ModdedDeviceUnit.drop(impulse) end

function ModdedDeviceUnit.reset_child_z_index() end

---@param new_state boolean
function ModdedDeviceUnit.set_autosvc(new_state) end

---@param new_value string
function ModdedDeviceUnit.update_user_note(new_value) end

function ModdedDeviceUnit.toggle_mount_lock() end

function ModdedDeviceUnit.remove_and_free_object() end

function ModdedDeviceUnit.reset_child_z_index() end

---@param base_val integer
function ModdedDeviceUnit.lift_child_z_index(base_val) end

---@param test_picker Object
---@return Object
function ModdedDeviceUnit.get_picker_type(test_picker) end
...
---@param gpos Vector2
function ModdedDeviceUnit.setup_teleport(gpos) end
