...
function _9FirewallConfigurationWorld.add_location(sfp, suppress_notification) end
...
function _9FirewallConfigurationWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function _9FirewallConfigurationWorld.get_device_replacement_rate(_device) end
