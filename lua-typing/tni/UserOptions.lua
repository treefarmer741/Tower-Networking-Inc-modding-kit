...
---@return boolean
function UserOptions.user_requirements_satisfied(candid, pending) end

---@param force_spawn boolean?  # Default = false
function UserOptions.execute_random_build_option(force_spawn) end

---@param user_sfps Array<string>
---@param force_spawn boolean?  # Default = false
function UserOptions.build_users_pack(user_sfps, force_spawn) end

---@param new_date integer
function UserOptions.trigger_date_elapsed(new_date) end
