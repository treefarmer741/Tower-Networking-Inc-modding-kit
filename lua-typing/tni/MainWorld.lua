...
function MainWorld.add_location(sfp, suppress_notification) end
...
function MainWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function MainWorld.get_device_replacement_rate(_device) end
