...
---@class A12VlanSetupWorld : GameWorld
---@field last_tutorial_name string
---@field tutorial_floor Object
---@field vlan_show_switch_count integer
...
local A12VlanSetupWorld = {}

function A12VlanSetupWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function A12VlanSetupWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function A12VlanSetupWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function A12VlanSetupWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function A12VlanSetupWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function A12VlanSetupWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function A12VlanSetupWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function A12VlanSetupWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function A12VlanSetupWorld.add_autocomplete_candidate(candid) end

---@param candid string
function A12VlanSetupWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function A12VlanSetupWorld.get_loc_index(loc) end

---@param sfp string
---@param suppress_notification boolean?  # Default = false
function A12VlanSetupWorld.add_location(sfp, suppress_notification) end

---@param peer_id integer
---@return MultiplayerMouse
function A12VlanSetupWorld.add_player(peer_id) end

function A12VlanSetupWorld.try_resume_daycycle() end

function A12VlanSetupWorld.master_timeout() end

function A12VlanSetupWorld.second_elapsed() end

function A12VlanSetupWorld.artifact_timeout() end

---@param peer_id integer
function A12VlanSetupWorld.remove_player(peer_id) end

---@return Object
function A12VlanSetupWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function A12VlanSetupWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function A12VlanSetupWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function A12VlanSetupWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function A12VlanSetupWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function A12VlanSetupWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function A12VlanSetupWorld.sync_pmsg_delta(s_pmsg) end

function A12VlanSetupWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function A12VlanSetupWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function A12VlanSetupWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function A12VlanSetupWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function A12VlanSetupWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function A12VlanSetupWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function A12VlanSetupWorld.remove_player_hosting(fqdn) end

---@param traffic_class string
---@param hex_rgb string
function A12VlanSetupWorld.set_tap_traffic_color(traffic_class, hex_rgb) end

---@param fqdn Object
---@param netaddr Object
function A12VlanSetupWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function A12VlanSetupWorld.update_server_timescale(timescale_arg) end
...
function A12VlanSetupWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function A12VlanSetupWorld.acquire_all_tech() end

function A12VlanSetupWorld.enable_all_listings() end

function A12VlanSetupWorld.enable_all_tech_and_listings() end

---@param _device DeviceUnit
---@return number
function A12VlanSetupWorld.get_device_replacement_rate(_device) end
