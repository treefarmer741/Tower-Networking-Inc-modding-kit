...
---@field prereq_ps Array<any> # Constant value: [(res://scenes/graph_network_simulation/programs/early_access/botnets/user_traffic_analyzer.tscn):<PackedScene#-9223353617535047716>]
---@field cost integer
