...
---@class TenaboltFusionPhaseOne : PropMod
...
---@return string
function TenaboltFusionPhaseOne.get_unlock_condition_description() end
...
---@return string
function TenaboltFusionPhaseOne.get_tiered_display_name() end
