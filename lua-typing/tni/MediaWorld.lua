...
function MediaWorld.add_location(sfp, suppress_notification) end
...
function MediaWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function MediaWorld.get_device_replacement_rate(_device) end
