...
---@class _2BasicNetworkingWorld : GameWorld
...
function _2BasicNetworkingWorld.add_location(sfp, suppress_notification) end
...
function _2BasicNetworkingWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function _2BasicNetworkingWorld.get_device_replacement_rate(_device) end
