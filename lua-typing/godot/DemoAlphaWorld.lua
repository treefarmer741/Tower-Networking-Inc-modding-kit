...
---@class DemoAlphaWorld : GameWorld
...
function DemoAlphaWorld.add_location(sfp, suppress_notification) end
...
function DemoAlphaWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function DemoAlphaWorld.get_device_replacement_rate(_device) end
