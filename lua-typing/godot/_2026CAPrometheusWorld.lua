...
---@class _2026CAPrometheusWorld : GameWorld
...
---@field satisfaction_threshold number
---@field satisfaction_bonus_per_user integer
...
local _2026CAPrometheusWorld = {}

---@param itemized boolean?  # Default = false
---@return table<any,any>
function _2026CAPrometheusWorld.calculate_payment_due_breakdown(itemized) end

---@param device DeviceUnit
---@return number
function _2026CAPrometheusWorld.get_device_replacement_rate(device) end

function _2026CAPrometheusWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function _2026CAPrometheusWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function _2026CAPrometheusWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function _2026CAPrometheusWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function _2026CAPrometheusWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function _2026CAPrometheusWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function _2026CAPrometheusWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function _2026CAPrometheusWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function _2026CAPrometheusWorld.add_autocomplete_candidate(candid) end

---@param candid string
function _2026CAPrometheusWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function _2026CAPrometheusWorld.get_loc_index(loc) end

---@param sfp string
---@param suppress_notification boolean?  # Default = false
function _2026CAPrometheusWorld.add_location(sfp, suppress_notification) end

---@param peer_id integer
---@return MultiplayerMouse
function _2026CAPrometheusWorld.add_player(peer_id) end

function _2026CAPrometheusWorld.try_resume_daycycle() end

function _2026CAPrometheusWorld.master_timeout() end

function _2026CAPrometheusWorld.second_elapsed() end

function _2026CAPrometheusWorld.artifact_timeout() end

---@param peer_id integer
function _2026CAPrometheusWorld.remove_player(peer_id) end

---@return Object
function _2026CAPrometheusWorld.debug_monitor_callback() end
...
---@return Object
function _2026CAPrometheusWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function _2026CAPrometheusWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function _2026CAPrometheusWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function _2026CAPrometheusWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function _2026CAPrometheusWorld.sync_pmsg_delta(s_pmsg) end

function _2026CAPrometheusWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function _2026CAPrometheusWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function _2026CAPrometheusWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function _2026CAPrometheusWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function _2026CAPrometheusWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function _2026CAPrometheusWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function _2026CAPrometheusWorld.remove_player_hosting(fqdn) end

---@param traffic_class string
---@param hex_rgb string
function _2026CAPrometheusWorld.set_tap_traffic_color(traffic_class, hex_rgb) end

---@param fqdn Object
---@param netaddr Object
function _2026CAPrometheusWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function _2026CAPrometheusWorld.update_server_timescale(timescale_arg) end
...
function _2026CAPrometheusWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function _2026CAPrometheusWorld.acquire_all_tech() end

function _2026CAPrometheusWorld.enable_all_listings() end

function _2026CAPrometheusWorld.enable_all_tech_and_listings() end

---@param _device DeviceUnit
---@return number
function _2026CAPrometheusWorld.get_device_replacement_rate(_device) end
