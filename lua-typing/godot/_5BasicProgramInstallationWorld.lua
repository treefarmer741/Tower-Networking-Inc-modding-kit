...
---@class _5BasicProgramInstallationWorld : GameWorld
...
function _5BasicProgramInstallationWorld.add_location(sfp, suppress_notification) end
...
function _5BasicProgramInstallationWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function _5BasicProgramInstallationWorld.get_device_replacement_rate(_device) end
