...
---@class JailbreakingResearch : PropMod
...
---@return string
function JailbreakingResearch.get_tiered_display_name() end

---@return string
function JailbreakingResearch.get_unlock_condition_description() end
