...
function DeviceWorld.add_location(sfp, suppress_notification) end
...
function DeviceWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function DeviceWorld.get_device_replacement_rate(_device) end
