...
---@class A10DhcpSetupWorld : GameWorld
...
local A10DhcpSetupWorld = {}

function A10DhcpSetupWorld.recompute_diff_hash() end

---@param msg_id Object
---@param gm GameMessage
function A10DhcpSetupWorld.update_player_msg(msg_id, gm) end

---@param msg_id Object
---@return Object
function A10DhcpSetupWorld.get_player_msg(msg_id) end

---@param n_date Object
---@param count_map table<any,any>
---@return Object
function A10DhcpSetupWorld.get_transactional_sum(n_date, count_map) end

---@param domain Object
---@return Object
function A10DhcpSetupWorld.lookup_domain(domain) end

---@param merchant_sfp Object
---@return Object
function A10DhcpSetupWorld.test_merchant_existence(merchant_sfp) end

---@param merchant_sfp Object
function A10DhcpSetupWorld.try_add_merchant(merchant_sfp) end

---@param prog_scene PackedScene
---@param notifprogstack Object?  # Default = <null>
function A10DhcpSetupWorld.try_release_program(prog_scene, notifprogstack) end

---@param candid string
function A10DhcpSetupWorld.add_autocomplete_candidate(candid) end

---@param candid string
function A10DhcpSetupWorld.remove_autocomplete_candidate(candid) end

---@param loc Location
---@return Object
function A10DhcpSetupWorld.get_loc_index(loc) end

---@param sfp string
---@param suppress_notification boolean?  # Default = false
function A10DhcpSetupWorld.add_location(sfp, suppress_notification) end

---@param peer_id integer
---@return MultiplayerMouse
function A10DhcpSetupWorld.add_player(peer_id) end

function A10DhcpSetupWorld.try_resume_daycycle() end

function A10DhcpSetupWorld.master_timeout() end

function A10DhcpSetupWorld.second_elapsed() end

function A10DhcpSetupWorld.artifact_timeout() end

---@param peer_id integer
function A10DhcpSetupWorld.remove_player(peer_id) end

---@return Object
function A10DhcpSetupWorld.debug_monitor_callback() end

---@param itemized boolean?  # Default = false
---@return table<any,any>
function A10DhcpSetupWorld.calculate_payment_due_breakdown(itemized) end

---@param subname string
---@return Object
function A10DhcpSetupWorld.get_full_savepath(subname) end

---@param msg Object
---@param by_force boolean?  # Default = false
function A10DhcpSetupWorld.trigger_game_over(msg, by_force) end

---@param failing_user User
function A10DhcpSetupWorld.submit_user_complaint(failing_user) end

---@param s_ptrans Array<any>
function A10DhcpSetupWorld.sync_ptrans_delta(s_ptrans) end

---@param s_pmsg Array<any>
function A10DhcpSetupWorld.sync_pmsg_delta(s_pmsg) end

function A10DhcpSetupWorld.update_last_node_spawn_ts_now() end

---@param curr_day Object
function A10DhcpSetupWorld.trigger_day_elapse(curr_day) end

---@param title string
---@param license_cost integer
function A10DhcpSetupWorld.acquire_app_license(title, license_cost) end

---@param amount Object
---@param details Object
---@param category CreditTransaction.Category?  # Default = 0
function A10DhcpSetupWorld.modify_player_cash(amount, details, category) end

---@param title Object
---@param msg Object
---@param tone_enum integer?  # Default = 0
function A10DhcpSetupWorld.send_player_message(title, msg, tone_enum) end

---@param fqdn string
---@param use_spec_csv string
---@param ppu number
function A10DhcpSetupWorld.add_player_hosting(fqdn, use_spec_csv, ppu) end

---@param fqdn string
function A10DhcpSetupWorld.remove_player_hosting(fqdn) end

---@param traffic_class string
---@param hex_rgb string
function A10DhcpSetupWorld.set_tap_traffic_color(traffic_class, hex_rgb) end

---@param fqdn Object
---@param netaddr Object
function A10DhcpSetupWorld.put_dns_entry(fqdn, netaddr) end

---@param timescale_arg number
function A10DhcpSetupWorld.update_server_timescale(timescale_arg) end
...
function A10DhcpSetupWorld.submit_alert_with_lowpass(normal_alert_title, normal_alert_full_msg, lowpass_alert_title, lowpass_alert_full_msg) end

function A10DhcpSetupWorld.acquire_all_tech() end

function A10DhcpSetupWorld.enable_all_listings() end

function A10DhcpSetupWorld.enable_all_tech_and_listings() end

---@param _device DeviceUnit
---@return number
function A10DhcpSetupWorld.get_device_replacement_rate(_device) end
