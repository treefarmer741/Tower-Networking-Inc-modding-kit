...
---@class UndervoltageDirective : OutageSurgePropMod
...
---@return string
function UndervoltageDirective.get_tiered_display_name() end

---@return string
function UndervoltageDirective.get_unlock_condition_description() end
