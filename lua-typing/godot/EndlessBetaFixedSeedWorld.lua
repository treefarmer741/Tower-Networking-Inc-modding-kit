...
---@class EndlessBetaFixedSeedWorld : GameWorld
...
function EndlessBetaFixedSeedWorld.add_location(sfp, suppress_notification) end
...
function EndlessBetaFixedSeedWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function EndlessBetaFixedSeedWorld.get_device_replacement_rate(_device) end
