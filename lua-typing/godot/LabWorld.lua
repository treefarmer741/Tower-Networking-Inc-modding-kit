...
function LabWorld.add_location(sfp, suppress_notification) end
...
function LabWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function LabWorld.get_device_replacement_rate(_device) end
