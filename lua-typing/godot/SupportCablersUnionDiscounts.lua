...
---@class SupportCablersUnionDiscounts : MerchantListingMod
---@field cost integer
...
---@return string
function SupportCablersUnionDiscounts.get_tiered_display_name() end

---@return string
function SupportCablersUnionDiscounts.get_unlock_condition_description() end
