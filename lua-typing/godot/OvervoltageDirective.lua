...
---@class OvervoltageDirective : OutageSurgePropMod
...
---@return string
function OvervoltageDirective.get_tiered_display_name() end

---@return string
function OvervoltageDirective.get_unlock_condition_description() end
