...
function _1BasicGameControlWorld.add_location(sfp, suppress_notification) end
...
function _1BasicGameControlWorld.set_tap_traffic_color(traffic_class, hex_rgb) end
...
---@return number
function _1BasicGameControlWorld.get_device_replacement_rate(_device) end
