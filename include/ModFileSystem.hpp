...
struct ModFileSystem : public Node {
	...
	inline Variant open(String mod_path, int64_t flags);
	inline Variant get_directories_at(String mod_path);
	inline Variant get_files_at(String mod_path);
...
inline Variant ModFileSystem::open(String mod_path, int64_t flags) { return operator()("open", mod_path, flags); }
inline Variant ModFileSystem::get_directories_at(String mod_path) { return operator()("get_directories_at", mod_path); }
inline Variant ModFileSystem::get_files_at(String mod_path) { return operator()("get_files_at", mod_path); }
