...
struct Avr : public DeviceUnit {
	using DeviceUnit::DeviceUnit;

	constexpr Avr(DeviceUnit base) : DeviceUnit{base} {}
	constexpr Avr(uint64_t addr) : DeviceUnit{addr} {}
...
inline void Avr::play_surge_effects() { this->voidcall("play_surge_effects"); }
inline void Avr::set_disp(String disptext) { this->voidcall("set_disp", disptext); }
inline void Avr::apply_autoconfig() { this->voidcall("apply_autoconfig"); }
inline void Avr::reposition(Variant new_pos) { this->voidcall("reposition", new_pos); }
inline void Avr::elevator_move(Variant new_pos) { this->voidcall("elevator_move", new_pos); }
inline double Avr::get_device_bounding_height() { return this->operator()("get_device_bounding_height"); }
inline Variant Avr::get_global_y_range() { return this->operator()("get_global_y_range"); }
inline Variant Avr::get_local_y_range() { return this->operator()("get_local_y_range"); }
inline Variant Avr::debug_monitor_callback() { return this->operator()("debug_monitor_callback"); }
inline Variant Avr::debug_mux_setup() { return this->operator()("debug_mux_setup"); }
inline Variant Avr::update_in_trolley_state() { return this->operator()("update_in_trolley_state"); }
inline bool Avr::pickup(Variant new_picker) { return this->operator()("pickup", new_picker); }
inline bool Avr::drop(Variant impulse) { return this->operator()("drop", impulse); }
inline void Avr::reset_child_z_index() { this->voidcall("reset_child_z_index"); }
inline void Avr::set_autosvc(bool new_state) { this->voidcall("set_autosvc", new_state); }
inline void Avr::update_user_note(String new_value) { this->voidcall("update_user_note", new_value); }
inline void Avr::toggle_mount_lock() { this->voidcall("toggle_mount_lock"); }
inline void Avr::remove_and_free_object() { this->voidcall("remove_and_free_object"); }
inline void Avr::lift_child_z_index(int64_t base_val) { this->voidcall("lift_child_z_index", base_val); }
inline Variant Avr::get_picker_type(Variant test_picker) { return this->operator()("get_picker_type", test_picker); }
inline void Avr::setup_teleport(Variant gpos) { this->voidcall("setup_teleport", gpos); }
