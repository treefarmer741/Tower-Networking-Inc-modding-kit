...
struct InertPanel : public DeviceUnit {
	using DeviceUnit::DeviceUnit;

	constexpr InertPanel(DeviceUnit base) : DeviceUnit{base} {}
	constexpr InertPanel(uint64_t addr) : DeviceUnit{addr} {}
...
inline void InertPanel::apply_autoconfig() { this->voidcall("apply_autoconfig"); }
inline void InertPanel::reposition(Variant new_pos) { this->voidcall("reposition", new_pos); }
inline void InertPanel::elevator_move(Variant new_pos) { this->voidcall("elevator_move", new_pos); }
inline double InertPanel::get_device_bounding_height() { return this->operator()("get_device_bounding_height"); }
inline Variant InertPanel::get_global_y_range() { return this->operator()("get_global_y_range"); }
inline Variant InertPanel::get_local_y_range() { return this->operator()("get_local_y_range"); }
inline Variant InertPanel::debug_monitor_callback() { return this->operator()("debug_monitor_callback"); }
inline Variant InertPanel::debug_mux_setup() { return this->operator()("debug_mux_setup"); }
inline Variant InertPanel::update_in_trolley_state() { return this->operator()("update_in_trolley_state"); }
inline bool InertPanel::pickup(Variant new_picker) { return this->operator()("pickup", new_picker); }
inline bool InertPanel::drop(Variant impulse) { return this->operator()("drop", impulse); }
inline void InertPanel::reset_child_z_index() { this->voidcall("reset_child_z_index"); }
inline void InertPanel::set_autosvc(bool new_state) { this->voidcall("set_autosvc", new_state); }
inline void InertPanel::update_user_note(String new_value) { this->voidcall("update_user_note", new_value); }
inline void InertPanel::remove_and_free_object() { this->voidcall("remove_and_free_object"); }
inline void InertPanel::lift_child_z_index(int64_t base_val) { this->voidcall("lift_child_z_index", base_val); }
inline Variant InertPanel::get_picker_type(Variant test_picker) { return this->operator()("get_picker_type", test_picker); }
inline void InertPanel::setup_teleport(Variant gpos) { this->voidcall("setup_teleport", gpos); }
