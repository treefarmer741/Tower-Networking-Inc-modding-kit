...
struct CableOMatic : public DeviceUnit {
	using DeviceUnit::DeviceUnit;

	constexpr CableOMatic(DeviceUnit base) : DeviceUnit{base} {}
	constexpr CableOMatic(uint64_t addr) : DeviceUnit{addr} {}
...
inline void CableOMatic::apply_autoconfig() { this->voidcall("apply_autoconfig"); }
inline void CableOMatic::reposition(Variant new_pos) { this->voidcall("reposition", new_pos); }
inline void CableOMatic::elevator_move(Variant new_pos) { this->voidcall("elevator_move", new_pos); }
inline double CableOMatic::get_device_bounding_height() { return this->operator()("get_device_bounding_height"); }
inline Variant CableOMatic::get_global_y_range() { return this->operator()("get_global_y_range"); }
inline Variant CableOMatic::get_local_y_range() { return this->operator()("get_local_y_range"); }
inline Variant CableOMatic::debug_monitor_callback() { return this->operator()("debug_monitor_callback"); }
inline Variant CableOMatic::debug_mux_setup() { return this->operator()("debug_mux_setup"); }
inline Variant CableOMatic::update_in_trolley_state() { return this->operator()("update_in_trolley_state"); }
inline bool CableOMatic::pickup(Variant new_picker) { return this->operator()("pickup", new_picker); }
inline bool CableOMatic::drop(Variant impulse) { return this->operator()("drop", impulse); }
...
inline void CableOMatic::setup_teleport(Variant gpos) { this->voidcall("setup_teleport", gpos); }
