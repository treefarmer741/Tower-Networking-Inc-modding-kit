...
struct _6RouterConfigurationWorld : public GameWorld {
	using GameWorld::GameWorld;

	constexpr _6RouterConfigurationWorld(GameWorld base) : GameWorld{base} {}
	constexpr _6RouterConfigurationWorld(uint64_t addr) : GameWorld{addr} {}
...
inline Variant _6RouterConfigurationWorld::get_transactional_sum(Variant n_date, Variant count_map) { return this->operator()("get_transactional_sum", n_date, count_map); }
inline Variant _6RouterConfigurationWorld::lookup_domain(Variant domain) { return this->operator()("lookup_domain", domain); }
inline Variant _6RouterConfigurationWorld::test_merchant_existence(Variant merchant_sfp) { return this->operator()("test_merchant_existence", merchant_sfp); }
inline void _6RouterConfigurationWorld::try_add_merchant(Variant merchant_sfp) { this->voidcall("try_add_merchant", merchant_sfp); }
inline void _6RouterConfigurationWorld::try_release_program(PackedScene prog_scene, Variant notifprogstack) { this->voidcall("try_release_program", prog_scene, notifprogstack); }
inline void _6RouterConfigurationWorld::add_autocomplete_candidate(String candid) { this->voidcall("add_autocomplete_candidate", candid); }
inline void _6RouterConfigurationWorld::remove_autocomplete_candidate(String candid) { this->voidcall("remove_autocomplete_candidate", candid); }
inline Variant _6RouterConfigurationWorld::get_loc_index(const Location& loc) { return this->operator()("get_loc_index", Object(reinterpret_cast<const Object*>(&loc)->address())); }
inline void _6RouterConfigurationWorld::add_location(String sfp, bool suppress_notification) { this->voidcall("add_location", sfp, suppress_notification); }
inline MultiplayerMouse _6RouterConfigurationWorld::add_player(int64_t peer_id) { return MultiplayerMouse(this->operator()("add_player", peer_id).as_object().address()); }
inline void _6RouterConfigurationWorld::try_resume_daycycle() { this->voidcall("try_resume_daycycle"); }
inline void _6RouterConfigurationWorld::master_timeout() { this->voidcall("master_timeout"); }
inline void _6RouterConfigurationWorld::second_elapsed() { this->voidcall("second_elapsed"); }
inline void _6RouterConfigurationWorld::artifact_timeout() { this->voidcall("artifact_timeout"); }
inline void _6RouterConfigurationWorld::remove_player(int64_t peer_id) { this->voidcall("remove_player", peer_id); }
inline Variant _6RouterConfigurationWorld::debug_monitor_callback() { return this->operator()("debug_monitor_callback"); }
inline Variant _6RouterConfigurationWorld::calculate_payment_due_breakdown(bool itemized) { return this->operator()("calculate_payment_due_breakdown", itemized); }
inline Variant _6RouterConfigurationWorld::get_full_savepath(String subname) { return this->operator()("get_full_savepath", subname); }
inline void _6RouterConfigurationWorld::trigger_game_over(Variant msg, bool by_force) { this->voidcall("trigger_game_over", msg, by_force); }
inline void _6RouterConfigurationWorld::submit_user_complaint(const User& failing_user) { this->voidcall("submit_user_complaint", Object(reinterpret_cast<const Object*>(&failing_user)->address())); }
inline void _6RouterConfigurationWorld::sync_ptrans_delta(Variant s_ptrans) { this->voidcall("sync_ptrans_delta", s_ptrans); }
inline void _6RouterConfigurationWorld::sync_pmsg_delta(Variant s_pmsg) { this->voidcall("sync_pmsg_delta", s_pmsg); }
inline void _6RouterConfigurationWorld::update_last_node_spawn_ts_now() { this->voidcall("update_last_node_spawn_ts_now"); }
...
inline double _6RouterConfigurationWorld::get_device_replacement_rate(const DeviceUnit& _device) { return this->operator()("get_device_replacement_rate", Object(reinterpret_cast<const Object*>(&_device)->address())); }
