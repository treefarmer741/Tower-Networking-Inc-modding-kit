...
struct UserTraversal : public TraversalConsume {
	...
	enum struct HostSelMethod : int64_t {  // NOTE: You should recompile your mod if this enum changes!
		UNIFORM_RANDOM = 0,
		USER_REPEATS_MODULO = 1,
		WEIGHTED_REQUIREMENTS_SHARE = 2,
	};
	static constexpr double MAX_PHASE_OFFSET = 0.04166666666667;  // NOTE: You should recompile your mod if this value changes!
...
inline int64_t UserTraversal::process_network_packet(const PacketControlModule& pktctl, Variant packet) { return this->operator()("process_network_packet", Object(reinterpret_cast<const Object*>(&pktctl)->address()), packet); }
inline bool UserTraversal::is_pkt_for_self(Variant packet) { return this->operator()("is_pkt_for_self", packet); }
inline bool UserTraversal::test_routing_exemption(Variant packet) { return this->operator()("test_routing_exemption", packet); }
