...
inline Variant LinkController::get_sizings_by_type(int64_t link_type) { return this->operator()("get_sizings_by_type", link_type); }
inline LinkSizing LinkController::get_sizing_by_type_and_id(int64_t link_type, int64_t sizing_id) { return LinkSizing(this->operator()("get_sizing_by_type_and_id", link_type, sizing_id).as_object().address()); }
