...
struct SupportCablersUnion : public PropMod {
	using PropMod::PropMod;

	constexpr SupportCablersUnion(PropMod base) : PropMod{base} {}
	constexpr SupportCablersUnion(uint64_t addr) : PropMod{addr} {}
